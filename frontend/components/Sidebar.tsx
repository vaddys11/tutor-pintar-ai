...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-72 shrink-0 flex-col border-r border-white/10 bg-gradient-to-b from-[#1e1b3a] to-[#15122b] text-slate-200">
      {/* Brand */}
      <div className="flex items-center gap-2.5 px-5 py-5">
        ...
        <div>
          <h1 className="text-sm font-bold leading-none text-white">Tutor Pintar AI</h1>
          <p className="mt-0.5 text-[11px] text-slate-400">Belajar seru, tanpa jawaban instan</p>
        </div>
      </div>
              ...
              {isRenaming ? (
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="shrink-0 text-slate-400 opacity-0 transition-opacity hover:text-indigo-300 group-hover:opacity-100"
